...
namespace DTcms.Web.admin.channel
{
    public partial class attribute_field_edit : Web.UI.ManagePage
    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            if (model.is_classify == 1)
            {
                cbIsClassify.Checked = true;
            }
            else
            {
                cbIsClassify.Checked = false;
            }
        ...
        {
            dlIsClssify.Visible = dlIsPassWord.Visible = dlIsHtml.Visible = dlEditorType.Visible = dlDataType.Visible
            ...
            switch (control_type)
            {
                ...
                case "multi-radio": //多项单选
                    dlIsClssify.Visible = dlDataType.Visible = dlDataLength.Visible = dlItemOption.Visible = true;
                    break;
                case "multi-checkbox": //多项多选
                    dlIsClssify.Visible = dlDataLength.Visible = dlItemOption.Visible = true;
                    break;
            }
