...
namespace DTcms.BLL
{
    ...
    public partial class article
    {
        ...
        {
            return dal.GetList(Top, strWhere, filedOrder, isLawView);
        }
        ...
        {
            return dal.GetList(Top, strWhere, name, value, filedOrder);
        }
        ...
        {
            return dal.GetList2(Top, strWhere, name, value, filedOrder);
        }
