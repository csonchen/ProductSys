...
<div class="tab-content">
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList ID="ddlControlType" runat="server" datatype="*" 
              ...
              <asp:ListItem Value="datetime">日期格式</asp:ListItem>
          </asp:DropDownList>
       </div>
     </dd>
  </dl>
  ...
  <dl>
   ...
   <dl id="dlIsClssify" runat="server" class="single-text-tr">
    <dt>是否为分类项</dt>
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="cbIsClassify" runat="server" />
      </div>
    </dd>
  </dl>
  ...
  <dl id="dlDataType" runat="server" class="multi-radio-tr">
   ...
   <dl id="dlDataLength" runat="server" class="single-text-tr multi-text-tr multi-radio-tr multi-checkbox-tr">
    <dt>字符串长度</dt>
    <dd><asp:TextBox ID="txtDataLength" Enabled="false" runat="server" CssClass="input small" datatype="n" sucmsg=" "></asp:TextBox> <span class="Validform_checktip">*数字，默认50个字符</span></dd>
   </dl>
